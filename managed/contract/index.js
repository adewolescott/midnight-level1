...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      incrementWithSecret: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`incrementWithSecret: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const secretKey_0 = args_1[1];
        const expectedCommitment_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('incrementWithSecret',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secretKey_0).concat(_descriptor_0.toValue(expectedCommitment_0)),
        ...
        const result_0 = this._incrementWithSecret_0(context,
                                                     partialProofData,
                                                     secretKey_0,
                                                     expectedCommitment_0);
    ...
    this.impureCircuits = {
      incrementWithSecret: this.circuits.incrementWithSecret
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('incrementWithSecret', new __compactRuntime.ContractOperation());
  ...
  _incrementWithSecret_0(context,
                         partialProofData,
                         secretKey_0,
                         expectedCommitment_0)
  {
    const computedCommitment_0 = this._persistentHash_0(secretKey_0);
    const isValid_0 = this._equal_0(computedCommitment_0, expectedCommitment_0);
    __compactRuntime.assert(isValid_0, 'Invalid secret key');
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
