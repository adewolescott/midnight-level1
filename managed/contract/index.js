...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      depositPayroll: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`depositPayroll: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const depositAmount_0 = args_1[1];
        const newPayoutRoot_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('depositPayroll',
                                     'argument 1 (as invoked from Typescript)',
                                     'zeropay.compact line 15 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(newPayoutRoot_0.buffer instanceof ArrayBuffer && newPayoutRoot_0.BYTES_PER_ELEMENT === 1 && newPayoutRoot_0.length === 32)) {
          __compactRuntime.typeError('depositPayroll',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(depositAmount_0).concat(_descriptor_0.toValue(newPayoutRoot_0)),
        ...
        const result_0 = this._depositPayroll_0(context,
                                                partialProofData,
                                                depositAmount_0,
                                                newPayoutRoot_0);
      ...
      claimPayout: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const publicNullifier_0 = args_1[1];
        const payoutAmount_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claimPayout',
                                     'argument 1 (as invoked from Typescript)',
                                     'zeropay.compact line 25 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(publicNullifier_0.buffer instanceof ArrayBuffer && publicNullifier_0.BYTES_PER_ELEMENT === 1 && publicNullifier_0.length === 32)) {
          __compactRuntime.typeError('claimPayout',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'zeropay.compact line 25 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(publicNullifier_0).concat(_descriptor_1.toValue(payoutAmount_0)),
    ...
    this.impureCircuits = {
      depositPayroll: this.circuits.depositPayroll,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('depositPayroll', new __compactRuntime.ContractOperation());
  ...
  _getSecretKey_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getSecretKey',
                                 'return value',
                                 'zeropay.compact line 10 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _depositPayroll_0(context, partialProofData, depositAmount_0, newPayoutRoot_0)
  {
    __compactRuntime.assert(depositAmount_0 > 0n,
                            'ZeroPay: Deposit amount must be greater than zero');
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('zeropay.compact line 20 char 16: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(newPayoutRoot_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _claimPayout_0(context, partialProofData, publicNullifier_0, payoutAmount_0) {
    let t_0;
    __compactRuntime.assert((t_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             ...
                                                                                             [
                                                                                              ...
                                                                                              { popeq: { cached: false,
                                                                                                         result: undefined } }]).value),
                             t_0 >= payoutAmount_0),
                            'ZeroPay: Insufficient vault funds');
    __compactRuntime.assert(!_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'ZeroPay: Payout has already been claimed');
    const secret_0 = this._getSecretKey_0(context, partialProofData);
    const computedNullifier_0 = this._persistentHash_0([secret_0,
                                                        _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                  ...
                                                                                                                  [
                                                                                                                   ...
                                                                                                                   { popeq: { cached: false,
                                                                                                                              result: undefined } }]).value)]);
    __compactRuntime.assert(this._equal_0(computedNullifier_0, publicNullifier_0),
                            'ZeroPay: Invalid witness proof for nullifier');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
